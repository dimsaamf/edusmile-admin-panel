...
<div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <a class="btn btn-primary shadow-md mr-2" href="{{ route('users.create') }}"> Create New User</a>
                    </div>
                    <!-- BEGIN: Data List -->
                                ...
                                <div class="flex items-center justify-center">  
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{ route('users.edit',$user->id) }}"> <i data-lucide="edit" class="w-4 h-4 mr-1"></i> Edit </a>
